...
public class OptionInventaireMoveState extends State{
	...
	public OptionInventaireMoveState(Handler handler) {
		super(handler);
	...
	public void tick() {
				...
				if (confirm && i == 1 && iY == 1 && pos == 0 && handler.getKeyManager().keyJustPressed(KeyEvent.VK_ENTER)) {
					if (oui) {Options.setInventoryMove(true);} else if (non) {Options.setInventoryMove(false);}
	...
	public void render(Graphics g) {
		...
		if (retour || retour2) {
			...
			Text.drawString(g, "Comment jouer", x - 740, 135, true, Color.GRAY, Assets.fontTell45);
			Text.drawString(g, "Resolution *", x - 740, 200, true, Color.GRAY, Assets.fontTell45);
			Text.drawString(g, "FPS", x - 740, 318, true, Color.GRAY, Assets.fontTell45);
			Text.drawString(g, "Retour", x - 740, 378, true, Color.GRAY, Assets.fontTell45);
			
			} else if (Options.getLanguage() == "ENG") {
			Text.drawString(g, "Options menu", x - 755, 55, true, Color.YELLOW, Assets.fontTell45);
			
			Text.drawString(g, "How to play", x - 740, 135, true, Color.GRAY, Assets.fontTell45);
			Text.drawString(g, "Resolution *", x - 740, 200, true, Color.GRAY, Assets.fontTell45);
			Text.drawString(g, "FPS", x - 740, 318, true, Color.GRAY, Assets.fontTell45);
			Text.drawString(g, "Return", x - 740, 378, true, Color.GRAY, Assets.fontTell45);
			}
		}
		...
		if (Options.getLanguage() == "FR") {
			Text.drawString(g, "Bouger dans l'inventaire", 375, ySelected, true, Color.WHITE, Assets.fontTell32);
		Text.drawString(g, "Activer", x - 143, 320, true, Color.PINK, Assets.fontTell32);
		Text.drawString(g, "Désactiver", x + 137, 320, true, Color.PINK, Assets.fontTell32);
		...
		Text.drawString(g, "Retour", x - 200, 448 , true, Color.YELLOW, Assets.fontTell32);
			...
			Text.drawString(g, "Move in inventory", 375, ySelected, true, Color.WHITE, Assets.fontTell32);
		Text.drawString(g, "On", x - 143, 320, true, Color.PINK, Assets.fontTell32);
		Text.drawString(g, "Off", x + 137, 320, true, Color.PINK, Assets.fontTell32);
