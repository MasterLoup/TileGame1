...
public class OptionLangueState extends State{
	...
	private boolean confirm, fr, eng;
	...
	public OptionLangueState(Handler handler) {
		super(handler);
	...
	public void tick() {
		...
		// confirm *state*
				if (confirm && i == 1 && iY == 1 && pos == 0 && handler.getKeyManager().keyJustPressed(KeyEvent.VK_ENTER)) {
					if (fr) {Options.setLanguage("FR");} else if (eng) {Options.setLanguage("ENG"); System.out.println("ENGGG");}
					fr = false; confirm = false;
					retour2 = true;
					perm = true;
					active = true;
					}
	...
	public void render(Graphics g) {
		...
		if (retour || retour2) {
			...
			Text.drawString(g, "FPS", x - 740, 135, true, Color.GRAY, Assets.fontTell45);
			Text.drawString(g, "Retour", x - 740, 200, true, Color.GRAY, Assets.fontTell45);
			Text.drawString(g, "Comment jouer", x - 740, 318, true, Color.GRAY, Assets.fontTell45);
			Text.drawString(g, "Resolution *", x - 740, 378, true, Color.GRAY, Assets.fontTell45);
			
			} else if (Options.getLanguage() == "ENG") {
			Text.drawString(g, "Options menu", x - 755, 55, true, Color.YELLOW, Assets.fontTell45);
			
			Text.drawString(g, "FPS", x - 740, 135, true, Color.GRAY, Assets.fontTell45);
			Text.drawString(g, "Return", x - 740, 200, true, Color.GRAY, Assets.fontTell45);
			Text.drawString(g, "How to play", x - 740, 318, true, Color.GRAY, Assets.fontTell45);
			Text.drawString(g, "Resolution *", x - 740, 378, true, Color.GRAY, Assets.fontTell45);
			}
		}
		...
		if (Options.getLanguage() == "FR") {
			Text.drawString(g, "Langue", 375, ySelected, true, Color.WHITE, Assets.fontTell45);
		Text.drawString(g, "Français", x - 143, 320, true, Color.PINK, Assets.fontTell32);
		Text.drawString(g, "English", x + 137, 320, true, Color.PINK, Assets.fontTell32);
		...
		Text.drawString(g, "Retour", x - 200, 448 , true, Color.YELLOW, Assets.fontTell32);
			...
			Text.drawString(g, "Language", 375, ySelected, true, Color.WHITE, Assets.fontTell45);
		Text.drawString(g, "Français", x - 143, 320, true, Color.PINK, Assets.fontTell32);
		Text.drawString(g, "English", x + 137, 320, true, Color.PINK, Assets.fontTell32);
